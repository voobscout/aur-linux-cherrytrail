...
pkgbase=linux-cherrytrail       # Build kernel with a different name
_srcname=linux-4.9
pkgver=4.9.6
pkgrel=2
arch=('i686' 'x86_64')
...
source=("https://www.kernel.org/pub/linux/kernel/v4.x/${_srcname}.tar.xz"
        ...
        'https://github.com/hadess/rtl8723bs/files/709139/0_rt8723bs.txt'
        'https://github.com/hadess/rtl8723bs/files/680171/0001-ACPI-scan-Prefer-devices-without-_HID-_CID-for-_ADR-.patch.zip'
        )
...
prepare() {
  ...
  # https://github.com/hadess/rtl8723bs/issues/76
